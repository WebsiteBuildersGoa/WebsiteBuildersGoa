import { Box,Image, Heading, Flex, List, ListItem, Link, Text } from '@chakra-ui/react';
            ...
            >
                <Flex flexWrap="wrap" alignItems="start" justify="space-between">
                    <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
                        <Heading as="h5" color="#15ef29" mb="0.5rem" fontSize="20px" fontWeight="800">
                          WebsiteBuilder Goa
                        </Heading>
...
herf="career"
                    ...
                    <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
                        ...
                        <List lineHeight="2">
                            <LinkItem text="Mobile App Development" />
                            <LinkItem text="Web App Development" />
                            <LinkItem text="Custom App Development" />
                            <LinkItem text="IT Services" />
                    ...
                    <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1rem', lg: '0' }}>
                        <Heading as="h5" color="#15ef29" mb="0.5rem" fontSize="20px" fontWeight="800">
                           Packages
                        </Heading>
                        <List lineHeight="2">
                            <LinkItem text="Get free Quote" />
                            <LinkItem text="Contact Us" />
                            {/* <LinkItem text="Site Map" /> */}
                        </List>
                        <Flex mt='10px' justify="start" mb="2rem" alignItems="baseline">
                        <Box  >
          <Image
         boxSize={'120px'}
          alt={'Login Image'}
        ...
        />
            ...
            <Flex maxW="64rem" mx="auto" alignItems="center" px={4}>
            <Box  >
          <Image
         boxSize={'50px'}
          alt={'Login Image'}
        ...
        />
                ...
                <Text color='#ffffff4d' fontSize=" " pl="1rem">
