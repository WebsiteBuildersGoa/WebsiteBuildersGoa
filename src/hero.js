...
const features = [
    {
        title: 'Discussion',
        detail: 'We always give importance to your ideas & requirements,based on that we will prepare the plan of actions.',
        icon: (
            <svg
                aria-hidden="true"
                role="img"
    ...
    {
        title: 'Designing',
        detail: 'Based on the planning ,our designing team will design the best & matching design that feflects your concept.',
        icon: (
            <svg
                aria-hidden="true"
                role="img"
    ...
    {
        title: 'Development',
        detail: 'Our Team of expert developers will develop the website/app in such a way that it would be complete on time. ',
        icon: (
            <svg
                aria-hidden="true"
                role="img"
    ...
    {
        title: 'Launch',
        detail: 'After full fledgeed testing,we host your website/app.And our team will guide you how to manage your website.',
        icon: (
            <svg
                aria-hidden="true"
                role="img"
...
const HeroSection = () => {
    return (
        <Fragment>
            <Container maxW="6xl" my="" alignitems='center'px={{ base: 6, md: 10 }} py={10}>
                <Stack direction={{ base: 'column', md: 'row' }}>
                    <Stack direction="column" spacing={10} justifyContent="center">
                        <chakra.h1 bgGradient="linear(to-br,  white, #15aabf)" bgClip="text"
                            fontSize="4xl" lineHeight={1} fontWeight="bold" textAlign="left">
                           Our Process 
                            <chakra.span bgGradient="linear(to-br, white,  #15ef29)" bgClip="text">
                                {' '}
                                Projects and Components{' '}
                            </chakra.span>{' '}
                            <br /><Text bgGradient="linear(to-br,  white, #15aabf)" bgClip="text"
                                fontSize="4xl" lineHeight={1} fontWeight="bold" textAlign="left"> built on top of Chakra UI
                            </Text>
                        </chakra.h1>
                        <Text
                        ...
                        >
                            {features.map((feature, index) => (
                                <Stack key={index} direction={{ base: 'row', md: 'column' }} spacing={6}>
                                    <Flex
                                        p={3}
                                    ...
                                    <Stack direction="column" spacing={6}>
                                        <Text color=" #15ef29" fontSize="3xl" fontWeight="700">
                                            {feature.title}
                                        </Text>
                                        <Text fontSize="md" color="white" maxW={{ base: '100%', md: '200px' }}>
                                            {feature.detail}
                                        </Text>
                                    </Stack>
                                </Stack>
